...
\begin{equation}
\mid \Sigma_\varepsilon \mid \times \mid P(Q) \mid
\mbox { transitions}
\end{equation}
In an NFA, the max number of transitions is the total number of characters in the alphabet $\Sigma \cup \{\varepsilon\}$ times the total number of possible states, which is the size of the power set of Q.
